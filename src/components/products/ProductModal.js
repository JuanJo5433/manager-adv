...
const ProductModal = ({ isOpen, onClose, onSave, product }) => {
  ...
  const handleSubmit = (e) => {
    ...
    // Convertir el precio a número (float) antes de enviarlo
    const updatedFormData = {
      ...formData,
      price: parseFloat(formData.price),  // Convierte el precio de string a float
    };
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            ...
            <input
              ...
              value={formData.type}
              onChange={handleChange}
              placeholder="Ej: paquete, hotel, vuelo, tour"
              required
              className="w-full border px-3 py-2 rounded"
            />
          </div>
