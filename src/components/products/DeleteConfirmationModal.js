        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
            <div className="bg-white rounded-xl p-6 w-full max-w-md space-y-4">
                <div className="text-center">
                    ...
                    <h3 className="text-lg font-medium text-gray-900 mt-2">¿Eliminar producto?</h3>
                    <p className="text-sm text-gray-500 mt-2">Estás por eliminar este producto. Esta acción no se puede deshacer.</p>
                </div>
