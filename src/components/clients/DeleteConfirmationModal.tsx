...
interface Props {
  ...
  onClose: () => void;
  onConfirm: () => void;
  clientName?: string; // Hacemos el nombre opcional por si no está disponible
}
 ...
 * @param onConfirm - Función para confirmar la eliminación
 * @param clientName - Nombre del cliente a eliminar (opcional)
 */
      ...
      <div className="bg-white rounded-xl p-6 w-full max-w-md space-y-4">
        <div className="text-center">
          ...
          <p className="text-sm text-gray-500 mt-2">
            Estás por eliminar a {clientName || 'este cliente'}. Esta acción no se puede deshacer.
          </p>
        </div>
