...
const CreateTaskModal: FC<CreateTaskModalProps> = ({ onClose, onSave, process }) => {
  ...
  const handleUsersSelection = (selectedOption: SingleValue<SelectOption>) => {
  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      const fullTask: Task = {
        ...createdTask,
        user: process.users?.find(u => u.id === selectedUserId) || null,
        process: process,
        comments: [],
        createdAt: new Date(),
      };
